...
dependencies {
    implementation("me.rasztabiga.thesis:shared:0.10.18") {
        exclude(group = "org.axonframework", module = "axon-spring-boot-starter")
    }
    ...
    testImplementation(testFixtures("me.rasztabiga.thesis:shared:0.10.18"))
