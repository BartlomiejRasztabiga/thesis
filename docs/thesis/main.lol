\contentsline {lstlisting}{\numberline {5.1}{\ignorespaces Podział na pakiety części serwerowej projektu}}{30}{lstlisting.5.1}%
\contentsline {lstlisting}{\numberline {5.2}{\ignorespaces Kod kontrolera REST API obsługującego zapytania dotyczące zamówień}}{31}{lstlisting.5.2}%
\contentsline {lstlisting}{\numberline {5.3}{\ignorespaces Kod implementacji repozytorium dziedzinowego projekcji Zamówienia}}{32}{lstlisting.5.3}%
\contentsline {lstlisting}{\numberline {5.4}{\ignorespaces Kod komponentów odpowiedzialnych za rozpoczynanie zamówień}}{33}{lstlisting.5.4}%
\contentsline {lstlisting}{\numberline {5.5}{\ignorespaces Kod procesora zdarzeń budującego projekcję zamówienia}}{34}{lstlisting.5.5}%
