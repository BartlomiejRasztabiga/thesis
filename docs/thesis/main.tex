...
Praca prezentuje proces projektowania oraz implementacji aplikacji webowej opartej na architekturze mikroserwisowej.

\textbf{TODO}

\keywords architektura mikroserwisowa, skalowalnosć, spójność ostateczna, kolejki komunikatów, burza zdarzeń
...
The thesis presents the process of designing and implementing a web application based on microservice architecture

\textbf{TODO}

\secondkeywords microservice architecture, scalability, eventual consistency, message queues, event storming
