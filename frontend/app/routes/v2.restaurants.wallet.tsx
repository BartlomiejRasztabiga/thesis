...
export async function action({ request, params }: ActionArgs) {
  ...
  try {
    await withdrawBalance(request, values.payeeId, values.amount, values.accountNumber);
  } catch (e) {
      ...
      <div className="h-full">
        <Paper className="flex flex-col w-80 mx-auto items-center">
          <div className="flex flex-col items-center">
            ...
            <Typography variant="subtitle1" color="text.secondary">{data.payee.balance} PLN</Typography>
          </div>
          <hr className="w-full" />
          <div className="mt-8 mb-8">
            <Form method="post">
              ...
              <FormControl>
                <TextField name="amount" label="Amount" variant="outlined" type="number" />
                <TextField name="accountNumber" label="Account number" variant="outlined" />
